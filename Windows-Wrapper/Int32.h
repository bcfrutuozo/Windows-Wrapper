...
struct Int32 : public ValueType<Int32, int32_t>, public IConvertible
{
public:
	...
	static Int32 MaxValue() { return Int32(0x7fffffff); }
	static Int32 MinValue() { return Int32(0x80000000); }
};