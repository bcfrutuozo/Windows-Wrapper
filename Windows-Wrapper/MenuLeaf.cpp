...
//}
//
//void MenuLeaf::SetBackgroundColor(const Color& color) noexcept
//{
...
//	mi.hbrBack = CreateSolidBrush(RGB(m_BackgroundColor.GetR(), m_BackgroundColor.GetG(), m_BackgroundColor.GetB()));
//
//	SetMenuInfo(static_cast<HMENU>(Handle.ToPointer()), &mi);
//}
